...
<body>
    ...
    if(isset($_GET['step']) && $_GET['step'] == 1){ ?>
        <div class="step_1--instruction">
            ...
            <h1>Важливо! Потрібно перевести додаток в режим "опубліковано" інакше токен буде злітати через 7 днів подробиці : <a href="https://support.google.com/cloud/answer/10311615#zippy=%2Ctesting">тут</a></h1>
